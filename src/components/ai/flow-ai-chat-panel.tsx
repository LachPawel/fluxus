...
export function FlowAIChatPanel({
  ...
  return (
    ...
    >
      {/* Header */}
      <div className="flex items-center justify-between px-4 py-3 border-b border-slate-100 bg-gradient-to-r from-indigo-500 to-purple-600 rounded-t-xl">
          ...
          <form onSubmit={handleSubmit} className="p-4 border-t border-slate-100">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                className="w-11 h-11 bg-indigo-600 text-white rounded-xl hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center flex-shrink-0"
              >
